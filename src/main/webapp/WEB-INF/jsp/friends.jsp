    ...
    <div class="wrapper">
        ...
        <div class="box maxheight">
          <div class="inner">
            ...
            <div class="txt1">
              ...
              <ul class="img-list">
                <li> <img alt="" src="<c:url value='/resources/images/2page-img7.jpg'/>" /> Premium food (either at our restaraunt or delivered to your room) </li>
                <li> <img alt="" src="<c:url value='/resources/images/2page-img8.jpg'/>" /> Drinks and bevarages in your rooms </li>
                <li> <img alt="" src="<c:url value='/resources/images/2page-img9.jpg'/>" /> Daily cleaning (included into your package) </li>
                <li> <img alt="" src="<c:url value='/resources/images/2page-img10.jpg'/>" /> Free access to our gym and swimming pool </li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div class="content">
        <div class="indent">
          ...
          <div class="container">
            <div class="col-1"> <img alt="" src="<c:url value='/resources/images/2page-img11.jpg'/>" class="extra-img png"/>
              <dl class="list1">
            ...
            <div class="col-2"> <img alt="" src="/resources/images/2page-img12.png" class="extra-img png"/>
              <dl class="list1">
            ...
            <div class="col-3"> <img alt="" src="<c:url value='/resources/images/2page-img13.png'/>" class="extra-img png"/>
              <dl class="list1">
                <dt>Premium Rooms</dt>
                <dd>Omnis iste natus error sit volupta- tem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi.</dd>
